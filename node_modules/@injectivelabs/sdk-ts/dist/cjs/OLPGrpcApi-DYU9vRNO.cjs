...
let __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb_client = require("@injectivelabs/olp-proto-ts-v2/generated/goagen_olp_injective_dmm_v2_pb.client");
...
var OLPGrpcApi = class extends require_BaseIndexerGrpcConsumer.BaseIndexerGrpcConsumer {
	...
	get client() {
		return this.initClient(__injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb_client.InjectiveDmmV2Client);
	}
	async fetchEpochs(status) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetEpochsRequest.create();
	...
	async fetchMarketRewards(epochId) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetMarketRewardsRequest.create();
	...
	async fetchEligibleAddresses({ epochId, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetEligibleAddressesRequest.create();
	...
	async fetchEpochScores({ epochId, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetEpochScoresRequest.create();
		request.epochId = epochId;
		if (page) request.page = page;
	...
	async fetchEpochScoresHistory({ epochId, accountAddress, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetEpochScoresHistoryRequest.create();
		request.epochId = epochId;
	...
	async fetchTotalScores({ epochId, marketId, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetTotalScoresRequest.create();
		request.epochId = epochId;
	...
	async fetchTotalScoresHistory({ epochId, marketId, accountAddress, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetTotalScoresHistoryRequest.create();
		request.epochId = epochId;
		request.marketId = marketId;
		request.accountAddress = accountAddress;
		if (page) request.page = page;
	...
	async fetchRewardsDistribution({ epochId, height, page }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetRewardsDistributionRequest.create();
		request.epochId = epochId;
	...
	async fetchAccountVolumes({ epochId, accountAddress }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetAccountVolumesRequest.create();
		request.epochId = epochId;
		request.accountAddress = accountAddress;
	...
	async fetchRewardsEligibility({ epochId, accountAddress }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetRewardsEligibilityRequest.create();
	...
	async fetchMarketRewardsRange({ epochId, marketId }) {
		const request = __injectivelabs_olp_proto_ts_v2_generated_goagen_olp_injective_dmm_v2_pb.GetMarketRewardsRangeRequest.create();
		request.epochId = epochId;
		request.marketId = marketId;
...
//#endregion
Object.defineProperty(exports, 'OLPGrpcApi', {
  enumerable: true,
  get: function () {
    return OLPGrpcApi;
  }
