...
const objectKeysToEip712Types = ({ object, messageType, primaryType = "MsgValue" }) => {
	...
	for (const property in (0, snakecase_keys.default)(object)) {
		let propertyValue = (0, snakecase_keys.default)(object)[property];
		...
		if (type === "boolean") types.push({
		...
		} else if (type === "object") if (Array.isArray(propertyValue) && propertyValue.length === 0) throw new __injectivelabs_exceptions.GeneralException(/* @__PURE__ */ new Error("Array with length 0 found"));
			...
			if (arrayFirstType === "boolean" || arrayFirstType === "number" || arrayFirstType === "string") {
				for (const arrayEntry in propertyValue) if (typeof arrayEntry !== arrayFirstType) throw new __injectivelabs_exceptions.GeneralException(/* @__PURE__ */ new Error("Array with different types found"));
				...
				const propertyType = getObjectEip712PropertyType({
					property: (0, __injectivelabs_utils.snakeToPascal)(property),
			...
			} else throw new __injectivelabs_exceptions.GeneralException(/* @__PURE__ */ new Error("Array with elements of unknown type found"));
		...
		else throw new __injectivelabs_exceptions.GeneralException(/* @__PURE__ */ new Error(`Type ${property} not found`));
	}
...
const protoTypeToAminoType = (type) => {
	switch (type.startsWith("/") ? type.substring(1) : type) {
		...
		default: throw new __injectivelabs_exceptions.GeneralException(/* @__PURE__ */ new Error("Unknown message type: " + type));
	}
};
...
//#endregion
Object.defineProperty(exports, 'MsgBase', {
  enumerable: true,
  get: function () {
    return MsgBase;
  }
});
Object.defineProperty(exports, 'getObjectEip712PropertyType', {
  enumerable: true,
  get: function () {
    return getObjectEip712PropertyType;
  }
});
Object.defineProperty(exports, 'numberTypeToReflectionNumberType', {
  enumerable: true,
  get: function () {
    return numberTypeToReflectionNumberType;
  }
});
Object.defineProperty(exports, 'objectKeysToEip712Types', {
  enumerable: true,
  get: function () {
    return objectKeysToEip712Types;
  }
...
Object.defineProperty(exports, 'prepareSignBytes', {
  enumerable: true,
  get: function () {
    return prepareSignBytes;
  }
});
Object.defineProperty(exports, 'protoTypeToAminoType', {
  enumerable: true,
  get: function () {
    return protoTypeToAminoType;
  }
});
Object.defineProperty(exports, 'stringTypeToReflectionStringType', {
  enumerable: true,
  get: function () {
    return stringTypeToReflectionStringType;
  }
});