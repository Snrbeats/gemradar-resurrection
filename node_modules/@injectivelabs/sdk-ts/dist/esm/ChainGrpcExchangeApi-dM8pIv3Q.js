import { O as denomAmountFromGrpcChainDenomAmount } from "./utils-CewUFGKA.js";
import { t as _defineProperty } from "./defineProperty-DuYPbdEg.js";
import { o as ChainModule } from "./ChainRestTendermintApi-iiW50Z2J.js";
...
var ChainGrpcExchangeApi = class extends BaseGrpcConsumer {
	...
	async fetchModuleState() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryModuleStateRequest.create();
	...
	async fetchFeeDiscountSchedule() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryFeeDiscountScheduleRequest.create();
	...
	async fetchFeeDiscountAccountInfo(injectiveAddress) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryFeeDiscountAccountInfoRequest.create();
	...
	async fetchTradingRewardsCampaign() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryTradeRewardCampaignRequest.create();
	...
	async fetchTradeRewardPoints(injectiveAddresses) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryTradeRewardPointsRequest.create();
	...
	async fetchPositions() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryPositionsRequest.create();
	...
	async fetchSubaccountTradeNonce(subaccountId) {
		const request = InjectiveExchangeV1Beta1QueryPb.QuerySubaccountTradeNonceRequest.create();
	...
	async fetchIsOptedOutOfRewards(account) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryIsOptedOutOfRewardsRequest.create();
	...
	async fetchActiveStakeGrant(account) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryActiveStakeGrantRequest.create();
	...
	async fetchDenomDecimal(denom) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryDenomDecimalRequest.create();
		request.denom = denom;
		return (await this.executeGrpcCall(request, this.client.denomDecimal.bind(this.client))).decimal;
	}
	async fetchDenomDecimals() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryDenomDecimalsRequest.create();
	...
	async fetchDenomMinNotional(denom) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryDenomMinNotionalRequest.create();
		request.denom = denom;
	...
	async fetchDenomMinNotionals() {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryDenomMinNotionalsRequest.create();
	...
	async fetchDerivativeMarkets(status, marketIds) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryDerivativeMarketsRequest.create();
	...
	async fetchSpotMarkets(status, marketIds) {
		const request = InjectiveExchangeV1Beta1QueryPb.QuerySpotMarketsRequest.create();
		if (status) request.status = status;
		if (marketIds) request.marketIds = marketIds;
	...
	async fetchFullSpotMarkets(status, marketIds) {
		const request = InjectiveExchangeV1Beta1QueryPb.QueryFullSpotMarketsRequest.create();
		if (status) request.status = status;
		if (marketIds) request.marketIds = marketIds;
...
//#endregion
export { ChainGrpcExchangeTransformer as n, ChainGrpcExchangeApi as t };