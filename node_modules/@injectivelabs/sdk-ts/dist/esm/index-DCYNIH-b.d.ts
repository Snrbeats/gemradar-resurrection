...
//#endregion
//#region ../../node_modules/.pnpm/snakecase-keys@5.5.0/node_modules/snakecase-keys/index.d.ts
...
declare namespace snakecaseKeys {
  ...
  */
  export type SnakeCaseKeys<T extends ObjectUnion | readonly any[], Deep extends boolean = true, Exclude extends readonly unknown[] = EmptyTuple, Path extends string = ""> = T extends readonly any[] ?
  // Handle arrays or tuples.
  { [P in keyof T]: T[P] extends Record<string, unknown> | readonly any[] ? SnakeCaseKeys<T[P], Deep, Exclude> : T[P] } : T extends Record<string, unknown> ?
  // Handle objects.
  { [P in keyof T as [Includes<Exclude, P>] extends [true] ? P : SnakeCase<P>]: [Deep] extends [true] ? T[P] extends ObjectUnion | readonly any[] ? SnakeCaseKeys<T[P], Deep, Exclude, AppendPath<Path, P & string>> : T[P] : T[P] } :
...
*/
declare function snakecaseKeys<T extends Record<string, unknown> | readonly any[], Options$1 extends snakecaseKeys.Options>(input: T, options?: Options$1): snakecaseKeys.SnakeCaseKeys<T, Options$1["deep"] extends boolean ? Options$1["deep"] : true, WithDefault<Options$1["exclude"], EmptyTuple>>;
//#endregion
