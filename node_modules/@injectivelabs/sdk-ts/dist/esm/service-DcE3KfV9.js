...
const getAssetMicroserviceEndpoint = (network = Network.Mainnet) => {
	if (isTestnet(network)) return TESTNET_ASSET_PRICE_SERVICE_URL;
	if (isDevnet(network)) return DEVNET_ASSET_PRICE_SERVICE_URL;
...
var TokenFactoryStatic = class {
	constructor(registry) {
		...
		_defineProperty(this, "tokensByDenom", void 0);
		_defineProperty(this, "tokensBySymbol", void 0);
		_defineProperty(this, "tokensByAddress", void 0);
	...
	getMetaByDenomOrAddress(denomOrAddress) {
		...
		return this.tokensByAddress[formattedDenom].find(({ tokenVerification }) => tokenVerification === TokenVerification.Verified) || this.tokensByAddress[formattedDenom][0];
	}
};
...
var TokenStaticFactory = class {
	constructor(registry) {
		_defineProperty(this, "registry", void 0);
		_defineProperty(this, "denomVerifiedMap", void 0);
		_defineProperty(this, "denomBlacklistedMap", void 0);
		_defineProperty(this, "denomUnverifiedMap", void 0);
		_defineProperty(this, "cw20AddressVerifiedMap", void 0);
		_defineProperty(this, "cw20AddressUnverifiedMap", void 0);
		_defineProperty(this, "factoryTokenDenomVerifiedMap", void 0);
		_defineProperty(this, "factoryTokenDenomUnverifiedMap", void 0);
		_defineProperty(this, "ibcDenomsVerifiedMap", void 0);
		_defineProperty(this, "ibcDenomsUnverifiedMap", void 0);
		_defineProperty(this, "ibcBaseDenomsVerifiedMap", void 0);
		_defineProperty(this, "ibcBaseDenomsUnverifiedMap", void 0);
		_defineProperty(this, "symbolTokensMap", void 0);
		_defineProperty(this, "insuranceTokensMap", void 0);
		this.registry = registry;
	...
	mapRegistry(registry) {
		for (const token of registry) {
			...
			if (tokenType === TokenType.InsuranceFund) this.insuranceTokensMap[symbol.toLowerCase()] = token;
			if (denom.startsWith("factory/")) if (tokenVerification === TokenVerification.Verified) this.factoryTokenDenomVerifiedMap[denom] = token;
			else this.factoryTokenDenomUnverifiedMap[denom] = token;
			if (tokenType === TokenType.Cw20) if (tokenVerification === TokenVerification.Verified) this.cw20AddressVerifiedMap[address] = token;
			else this.cw20AddressUnverifiedMap[address] = token;
			if (tokenType === TokenType.Ibc) if (tokenVerification === TokenVerification.Verified) {
	...
	getIbcToken(denom, { source, tokenVerification } = {}) {
		...
		if (source) return (tokenVerification === TokenVerification.Verified ? Object.values(this.ibcDenomsVerifiedMap) : [...Object.values(this.ibcDenomsVerifiedMap), ...Object.values(this.ibcDenomsVerifiedMap).flat()]).find((token) => token.source === source && (token.denom === denomTrimmed || (token === null || token === void 0 ? void 0 : token.baseDenom) === denomTrimmed));
		if (tokenVerification === TokenVerification.Verified) return this.ibcBaseDenomsVerifiedMap[denomTrimmed] || this.ibcDenomsVerifiedMap[denomTrimmed];
	...
	getCw20Token(address, { tokenVerification } = {}) {
		if (tokenVerification === TokenVerification.Verified) return this.cw20AddressVerifiedMap[address];
	...
	getTokenFactoryToken(denom, { tokenVerification } = {}) {
		if (tokenVerification === TokenVerification.Verified) return this.factoryTokenDenomVerifiedMap[denom];
	...
	toToken(denomOrSymbol, { source, verification } = {}) {
		...
		if (isCw20ContractAddress(denomOrSymbolTrimmed)) return this.getCw20Token(denomOrSymbolTrimmed, { tokenVerification: verification });
...
//#endregion
export { TokenFactoryStatic as n, TokenPrice as r, TokenStaticFactory as t };