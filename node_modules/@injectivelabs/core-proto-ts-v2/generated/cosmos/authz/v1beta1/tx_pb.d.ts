 ...
 *
 * @deprecated
 * @generated from protobuf message cosmos.authz.v1beta1.MsgExecCompatResponse
 */
 ...
 *
 * @deprecated
 * @generated from protobuf message cosmos.authz.v1beta1.MsgExecCompat
 */
export interface MsgExecCompat {
    ...
    grantee: string;
    /**
     * @generated from protobuf field: repeated string msgs = 2
     */
    msgs: string[];
}
...
class MsgGrant$Type extends MessageType<MsgGrant> {
    constructor() {
        super("cosmos.authz.v1beta1.MsgGrant", [
            ...
            { no: 3, name: "grant", kind: "message", T: () => Grant, options: { "gogoproto.nullable": false, "amino.dont_omitempty": true } }
        ], { "amino.name": "cosmos-sdk/MsgGrant", "cosmos.msg.v1.signer": ["granter"] });
    }
...
class MsgExec$Type extends MessageType<MsgExec> {
    constructor() {
        super("cosmos.authz.v1beta1.MsgExec", [
            ...
            { no: 2, name: "msgs", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Any, options: { "cosmos_proto.accepts_interface": "cosmos.base.v1beta1.Msg" } }
        ], { "amino.name": "cosmos-sdk/MsgExec", "cosmos.msg.v1.signer": ["grantee"] });
    }
...
class MsgRevoke$Type extends MessageType<MsgRevoke> {
    constructor() {
        ...
        ], { "amino.name": "cosmos-sdk/MsgRevoke", "cosmos.msg.v1.signer": ["granter"] });
    }
...
// @generated message type with reflection information, may provide speed optimized methods
class MsgExecCompatResponse$Type extends MessageType<MsgExecCompatResponse> {
    constructor() {
        super("cosmos.authz.v1beta1.MsgExecCompatResponse", [
            { no: 1, name: "results", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<MsgExecCompatResponse>): MsgExecCompatResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.results = [];
        if (value !== undefined)
            reflectionMergePartial<MsgExecCompatResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MsgExecCompatResponse): MsgExecCompatResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: MsgExecCompatResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated bytes results = 1; */
        for (let i = 0; i < message.results.length; i++)
            writer.tag(1, WireType.LengthDelimited).bytes(message.results[i]);
        let u = options.writeUnknownFields;
...
/**
 * @deprecated
 * @generated MessageType for protobuf message cosmos.authz.v1beta1.MsgExecCompatResponse
 */
export const MsgExecCompatResponse = new MsgExecCompatResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MsgExecCompat$Type extends MessageType<MsgExecCompat> {
    constructor() {
        super("cosmos.authz.v1beta1.MsgExecCompat", [
            { no: 1, name: "grantee", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "msgs", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ], { "amino.name": "cosmos-sdk/MsgExec", "cosmos.msg.v1.signer": ["grantee"] });
    }
    create(value?: PartialMessage<MsgExecCompat>): MsgExecCompat {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.grantee = "";
        message.msgs = [];
        if (value !== undefined)
            reflectionMergePartial<MsgExecCompat>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MsgExecCompat): MsgExecCompat {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: MsgExecCompat, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string grantee = 1; */
        if (message.grantee !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.grantee);
        /* repeated string msgs = 2; */
        for (let i = 0; i < message.msgs.length; i++)
            writer.tag(2, WireType.LengthDelimited).string(message.msgs[i]);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @deprecated
 * @generated MessageType for protobuf message cosmos.authz.v1beta1.MsgExecCompat
 */
export const MsgExecCompat = new MsgExecCompat$Type();
/**
...
export const Msg = new ServiceType("cosmos.authz.v1beta1.Msg", [
    ...
    { name: "ExecCompat", options: {}, I: MsgExecCompat, O: MsgExecCompatResponse }
