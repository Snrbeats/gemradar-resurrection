...
class MsgUpdateNamespace$Type extends MessageType<MsgUpdateNamespace> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string denom */ 2:
                    ...
                    break;
                case /* injective.permissions.v1beta1.MsgUpdateNamespace.SetContractHook wasm_hook */ 3:
                ...
                case /* repeated injective.permissions.v1beta1.PolicyManagerCapability policy_manager_capabilities */ 7:
                    ...
                    break;
                case /* injective.permissions.v1beta1.MsgUpdateNamespace.SetContractHook evm_hook */ 8:
    ...
    internalBinaryWrite(message: MsgUpdateNamespace, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.permissions.v1beta1.MsgUpdateNamespace.SetContractHook wasm_hook = 3; */
        if (message.wasmHook)
        ...
        /* injective.permissions.v1beta1.MsgUpdateNamespace.SetContractHook evm_hook = 8; */
        if (message.evmHook)
