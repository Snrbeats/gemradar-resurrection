...
export interface MsgEthereumTxResponse {
     ...
     *
     * @generated from protobuf field: uint64 execution_gas_used = 7
     */
...
class MsgEthereumTxResponse$Type extends MessageType<MsgEthereumTxResponse> {
    constructor() {
        super("injective.evm.v1.MsgEthereumTxResponse", [
            ...
            { no: 7, name: "execution_gas_used", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bytes block_hash */ 6:
                    ...
                    break;
                case /* uint64 execution_gas_used */ 7:
