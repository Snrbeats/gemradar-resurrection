...
class OpenNotionalCap$Type extends MessageType {
  constructor() {
    ...
    ], { "amino.name": "injective.exchange.v1beta1.OpenNotionalCap" });
  }
  create(value) {
...
class OpenNotionalCapUncapped$Type extends MessageType {
  constructor() {
    super("injective.exchange.v1beta1.OpenNotionalCapUncapped", [], { "amino.name": "injective.exchange.v1beta1.OpenNotionalCapUncapped" });
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    if (value !== void 0)
...
class OpenNotionalCapCapped$Type extends MessageType {
  constructor() {
    ...
    ], { "amino.name": "injective.exchange.v1beta1.OpenNotionalCapCapped" });
  }
  create(value) {
    const message = globalThis.Object.create(this.messagePrototype);
    message.value = "";
