...
/**
 * @generated from protobuf message injective.exchange.v2.ForcePausedInfo
 */
export interface ForcePausedInfo {
    /**
     * @generated from protobuf field: injective.exchange.v2.ForcePausedReason reason = 1
     */
    reason: ForcePausedReason;
    /**
     * @generated from protobuf field: string mark_price_at_pausing = 2
     */
    markPriceAtPausing: string;
}
/**
...
export interface SpotMarket {
     ...
     *
     * @generated from protobuf field: bool has_disabled_minimal_protocol_fee = 16
     */
...
export interface BinaryOptionsMarket {
     ...
     * fee is disabled for the market
     *
     * @generated from protobuf field: bool has_disabled_minimal_protocol_fee = 22
     */
    hasDisabledMinimalProtocolFee: boolean;
    /**
     ...
     *
     * @generated from protobuf field: injective.exchange.v2.ForcePausedInfo force_paused_info = 23
     */
    forcePausedInfo?: ForcePausedInfo;
}
/**
...
export interface DerivativeMarket {
     ...
     * fee is disabled for the market
     *
     * @generated from protobuf field: bool has_disabled_minimal_protocol_fee = 23
     */
    hasDisabledMinimalProtocolFee: boolean;
    /**
     * force_paused_info defines additional info for force paused markets, only
     * set when status == ForcePaused
     *
     * @generated from protobuf field: injective.exchange.v2.ForcePausedInfo force_paused_info = 24
     */
    forcePausedInfo?: ForcePausedInfo;
}
/**
...
export enum MarketStatus {
    ...
    Expired = 4,
    /**
     * @generated from protobuf enum value: ForcePaused = 5;
     */
    ForcePaused = 5
}
/**
 * @generated from protobuf enum injective.exchange.v2.ForcePausedReason
 */
export enum ForcePausedReason {
    /**
     * @generated from protobuf enum value: QuoteDenomPaused = 0;
     */
    QuoteDenomPaused = 0
}
// @generated message type with reflection information, may provide speed optimized methods
class ForcePausedInfo$Type extends MessageType<ForcePausedInfo> {
    constructor() {
        super("injective.exchange.v2.ForcePausedInfo", [
            { no: 1, name: "reason", kind: "enum", T: () => ["injective.exchange.v2.ForcePausedReason", ForcePausedReason] },
            { no: 2, name: "mark_price_at_pausing", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": true, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec" } }
        ]);
    }
    create(value?: PartialMessage<ForcePausedInfo>): ForcePausedInfo {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.reason = 0;
        message.markPriceAtPausing = "";
        if (value !== undefined)
            reflectionMergePartial<ForcePausedInfo>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ForcePausedInfo): ForcePausedInfo {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* injective.exchange.v2.ForcePausedReason reason */ 1:
                    message.reason = reader.int32();
                    break;
                case /* string mark_price_at_pausing */ 2:
                    message.markPriceAtPausing = reader.string();
                    break;
                default:
    ...
    internalBinaryWrite(message: ForcePausedInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* injective.exchange.v2.ForcePausedReason reason = 1; */
        if (message.reason !== 0)
            writer.tag(1, WireType.Varint).int32(message.reason);
        /* string mark_price_at_pausing = 2; */
        if (message.markPriceAtPausing !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.markPriceAtPausing);
...
/**
 * @generated MessageType for protobuf message injective.exchange.v2.ForcePausedInfo
 */
export const ForcePausedInfo = new ForcePausedInfo$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OpenNotionalCap$Type extends MessageType<OpenNotionalCap> {
    constructor() {
        ...
        ], { "amino.name": "injective.exchange.v2.OpenNotionalCap" });
    }
...
class OpenNotionalCapUncapped$Type extends MessageType<OpenNotionalCapUncapped> {
    constructor() {
        super("injective.exchange.v2.OpenNotionalCapUncapped", [], { "amino.name": "injective.exchange.v2.OpenNotionalCapUncapped" });
    }
...
class OpenNotionalCapCapped$Type extends MessageType<OpenNotionalCapCapped> {
    constructor() {
        ...
        ], { "amino.name": "injective.exchange.v2.OpenNotionalCapCapped" });
    }
...
class SpotMarket$Type extends MessageType<SpotMarket> {
    constructor() {
        super("injective.exchange.v2.SpotMarket", [
            ...
            { no: 16, name: "has_disabled_minimal_protocol_fee", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<SpotMarket>): SpotMarket {
        ...
        message.hasDisabledMinimalProtocolFee = false;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 quote_decimals */ 15:
                    ...
                    break;
                case /* bool has_disabled_minimal_protocol_fee */ 16:
                    message.hasDisabledMinimalProtocolFee = reader.bool();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SpotMarket, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hasDisabledMinimalProtocolFee !== false)
            writer.tag(16, WireType.Varint).bool(message.hasDisabledMinimalProtocolFee);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class BinaryOptionsMarket$Type extends MessageType<BinaryOptionsMarket> {
    constructor() {
        super("injective.exchange.v2.BinaryOptionsMarket", [
            ...
            { no: 22, name: "has_disabled_minimal_protocol_fee", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 23, name: "force_paused_info", kind: "message", T: () => ForcePausedInfo }
        ], { "gogoproto.goproto_getters": false });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v2.OpenNotionalCap open_notional_cap */ 21:
                    ...
                    break;
                case /* bool has_disabled_minimal_protocol_fee */ 22:
                    message.hasDisabledMinimalProtocolFee = reader.bool();
                    break;
                case /* injective.exchange.v2.ForcePausedInfo force_paused_info */ 23:
                    message.forcePausedInfo = ForcePausedInfo.internalBinaryRead(reader, reader.uint32(), options, message.forcePausedInfo);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: BinaryOptionsMarket, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hasDisabledMinimalProtocolFee !== false)
            writer.tag(22, WireType.Varint).bool(message.hasDisabledMinimalProtocolFee);
        /* injective.exchange.v2.ForcePausedInfo force_paused_info = 23; */
        if (message.forcePausedInfo)
            ForcePausedInfo.internalBinaryWrite(message.forcePausedInfo, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class DerivativeMarket$Type extends MessageType<DerivativeMarket> {
    constructor() {
        super("injective.exchange.v2.DerivativeMarket", [
            ...
            { no: 23, name: "has_disabled_minimal_protocol_fee", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 24, name: "force_paused_info", kind: "message", T: () => ForcePausedInfo }
        ], { "gogoproto.goproto_getters": false });
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v2.OpenNotionalCap open_notional_cap */ 22:
                    message.openNotionalCap = OpenNotionalCap.internalBinaryRead(reader, reader.uint32(), options, message.openNotionalCap);
                    break;
                case /* bool has_disabled_minimal_protocol_fee */ 23:
                    message.hasDisabledMinimalProtocolFee = reader.bool();
                    break;
                case /* injective.exchange.v2.ForcePausedInfo force_paused_info */ 24:
                    message.forcePausedInfo = ForcePausedInfo.internalBinaryRead(reader, reader.uint32(), options, message.forcePausedInfo);
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: DerivativeMarket, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.hasDisabledMinimalProtocolFee !== false)
            writer.tag(23, WireType.Varint).bool(message.hasDisabledMinimalProtocolFee);
        /* injective.exchange.v2.ForcePausedInfo force_paused_info = 24; */
        if (message.forcePausedInfo)
            ForcePausedInfo.internalBinaryWrite(message.forcePausedInfo, writer.tag(24, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
