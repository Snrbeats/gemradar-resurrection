...
export interface SpotMarketParamUpdateProposal {
     ...
     *
     * @generated from protobuf field: injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 15
     */
...
export interface DerivativeMarketParamUpdateProposal {
     ...
     * is disabled for the market
     *
     * @generated from protobuf field: injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 20
     */
    hasDisabledMinimalProtocolFee: DisableMinimalProtocolFeeUpdate;
}
/**
...
export interface BinaryOptionsMarketParamUpdateProposal {
     ...
     * is disabled for the market
     *
     * @generated from protobuf field: injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 18
     */
    hasDisabledMinimalProtocolFee: DisableMinimalProtocolFeeUpdate;
}
/**
...
/**
 * @generated from protobuf enum injective.exchange.v2.DisableMinimalProtocolFeeUpdate
 */
export enum DisableMinimalProtocolFeeUpdate {
    /**
     * @generated from protobuf enum value: NoUpdate = 0;
     */
    NoUpdate = 0,
    /**
...
class SpotMarketParamUpdateProposal$Type extends MessageType<SpotMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v2.SpotMarketParamUpdateProposal", [
            ...
            { no: 15, name: "has_disabled_minimal_protocol_fee", kind: "enum", T: () => ["injective.exchange.v2.DisableMinimalProtocolFeeUpdate", DisableMinimalProtocolFeeUpdate], options: { "gogoproto.nullable": true } }
    ...
    create(value?: PartialMessage<SpotMarketParamUpdateProposal>): SpotMarketParamUpdateProposal {
        ...
        message.hasDisabledMinimalProtocolFee = 0;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint32 quote_decimals */ 14:
                    ...
                    break;
                case /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee */ 15:
                    message.hasDisabledMinimalProtocolFee = reader.int32();
                    break;
                default:
    ...
    internalBinaryWrite(message: SpotMarketParamUpdateProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 15; */
        if (message.hasDisabledMinimalProtocolFee !== 0)
            writer.tag(15, WireType.Varint).int32(message.hasDisabledMinimalProtocolFee);
...
class DerivativeMarketParamUpdateProposal$Type extends MessageType<DerivativeMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v2.DerivativeMarketParamUpdateProposal", [
            ...
            { no: 20, name: "has_disabled_minimal_protocol_fee", kind: "enum", T: () => ["injective.exchange.v2.DisableMinimalProtocolFeeUpdate", DisableMinimalProtocolFeeUpdate], options: { "gogoproto.nullable": true } }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v2.OpenNotionalCap open_notional_cap */ 19:
                    message.openNotionalCap = OpenNotionalCap.internalBinaryRead(reader, reader.uint32(), options, message.openNotionalCap);
                    break;
                case /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee */ 20:
                    message.hasDisabledMinimalProtocolFee = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: DerivativeMarketParamUpdateProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.openNotionalCap)
            OpenNotionalCap.internalBinaryWrite(message.openNotionalCap, writer.tag(19, WireType.LengthDelimited).fork(), options).join();
        /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 20; */
        if (message.hasDisabledMinimalProtocolFee !== 0)
            writer.tag(20, WireType.Varint).int32(message.hasDisabledMinimalProtocolFee);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class BinaryOptionsMarketParamUpdateProposal$Type extends MessageType<BinaryOptionsMarketParamUpdateProposal> {
    constructor() {
        super("injective.exchange.v2.BinaryOptionsMarketParamUpdateProposal", [
            ...
            { no: 18, name: "has_disabled_minimal_protocol_fee", kind: "enum", T: () => ["injective.exchange.v2.DisableMinimalProtocolFeeUpdate", DisableMinimalProtocolFeeUpdate], options: { "gogoproto.nullable": true } }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* injective.exchange.v2.OpenNotionalCap open_notional_cap */ 17:
                    message.openNotionalCap = OpenNotionalCap.internalBinaryRead(reader, reader.uint32(), options, message.openNotionalCap);
                    break;
                case /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee */ 18:
                    message.hasDisabledMinimalProtocolFee = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: BinaryOptionsMarketParamUpdateProposal, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* injective.exchange.v2.DisableMinimalProtocolFeeUpdate has_disabled_minimal_protocol_fee = 18; */
        if (message.hasDisabledMinimalProtocolFee !== 0)
            writer.tag(18, WireType.Varint).int32(message.hasDisabledMinimalProtocolFee);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
