 ...
 * number of blocks
 *
 * @generated from protobuf message injective.exchange.v2.MsgActivatePostOnlyMode
 */
export interface MsgActivatePostOnlyMode {
    /**
     * the sender's Injective address
     *
     * @generated from protobuf field: string sender = 1
     ...
     *
     * @generated from protobuf field: uint32 blocks_amount = 2
     */
    blocksAmount: number;
}
/**
 ...
 *
 * @generated from protobuf message injective.exchange.v2.MsgActivatePostOnlyModeResponse
 */
export interface MsgActivatePostOnlyModeResponse {
}
...
// @generated message type with reflection information, may provide speed optimized methods
class MsgActivatePostOnlyMode$Type extends MessageType<MsgActivatePostOnlyMode> {
    constructor() {
        super("injective.exchange.v2.MsgActivatePostOnlyMode", [
            { no: 1, name: "sender", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "blocks_amount", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ], { "amino.name": "exchange/MsgActivatePostOnlyMode", "cosmos.msg.v1.signer": ["sender"] });
    }
    create(value?: PartialMessage<MsgActivatePostOnlyMode>): MsgActivatePostOnlyMode {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.sender = "";
        message.blocksAmount = 0;
        if (value !== undefined)
            reflectionMergePartial<MsgActivatePostOnlyMode>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MsgActivatePostOnlyMode): MsgActivatePostOnlyMode {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: MsgActivatePostOnlyMode, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string sender = 1; */
        if (message.sender !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.sender);
...
/**
 * @generated MessageType for protobuf message injective.exchange.v2.MsgActivatePostOnlyMode
 */
export const MsgActivatePostOnlyMode = new MsgActivatePostOnlyMode$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MsgActivatePostOnlyModeResponse$Type extends MessageType<MsgActivatePostOnlyModeResponse> {
    constructor() {
        super("injective.exchange.v2.MsgActivatePostOnlyModeResponse", []);
    }
    create(value?: PartialMessage<MsgActivatePostOnlyModeResponse>): MsgActivatePostOnlyModeResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<MsgActivatePostOnlyModeResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: MsgActivatePostOnlyModeResponse): MsgActivatePostOnlyModeResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: MsgActivatePostOnlyModeResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message injective.exchange.v2.MsgActivatePostOnlyModeResponse
 */
export const MsgActivatePostOnlyModeResponse = new MsgActivatePostOnlyModeResponse$Type();
/**
