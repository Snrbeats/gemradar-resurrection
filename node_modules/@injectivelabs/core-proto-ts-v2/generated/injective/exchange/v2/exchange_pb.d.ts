 ...
 * signature
 *
 * @generated from protobuf message injective.exchange.v2.EnforcedRestrictionsContract
 */
export interface EnforcedRestrictionsContract {
    /**
     ...
     *
     * @generated from protobuf field: string pause_event_signature = 2
     */
...
export interface Params {
     ...
     *
     * @generated from protobuf field: repeated injective.exchange.v2.EnforcedRestrictionsContract enforced_restrictions_contracts = 36
     */
    enforcedRestrictionsContracts: EnforcedRestrictionsContract[];
}
/**
...
export enum ExecutionType {
    ...
    /**
     * @generated from protobuf enum value: Synthetic = 8;
     */
    Synthetic = 8
}
// @generated message type with reflection information, may provide speed optimized methods
class EnforcedRestrictionsContract$Type extends MessageType<EnforcedRestrictionsContract> {
    constructor() {
        super("injective.exchange.v2.EnforcedRestrictionsContract", [
            { no: 1, name: "contract_address", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
            { no: 2, name: "pause_event_signature", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ], { "gogoproto.equal": true });
    }
    create(value?: PartialMessage<EnforcedRestrictionsContract>): EnforcedRestrictionsContract {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.contractAddress = "";
        message.pauseEventSignature = "";
        if (value !== undefined)
            reflectionMergePartial<EnforcedRestrictionsContract>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EnforcedRestrictionsContract): EnforcedRestrictionsContract {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string contract_address */ 1:
                    ...
                    break;
                case /* string pause_event_signature */ 2:
                    message.pauseEventSignature = reader.string();
                    break;
                default:
    ...
    internalBinaryWrite(message: EnforcedRestrictionsContract, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string contract_address = 1; */
        if (message.contractAddress !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.contractAddress);
        /* string pause_event_signature = 2; */
        if (message.pauseEventSignature !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.pauseEventSignature);
...
/**
 * @generated MessageType for protobuf message injective.exchange.v2.EnforcedRestrictionsContract
 */
export const EnforcedRestrictionsContract = new EnforcedRestrictionsContract$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Params$Type extends MessageType<Params> {
    constructor() {
        super("injective.exchange.v2.Params", [
            ...
            { no: 36, name: "enforced_restrictions_contracts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => EnforcedRestrictionsContract, options: { "gogoproto.nullable": false } }
    ...
    create(value?: PartialMessage<Params>): Params {
        ...
        message.enforcedRestrictionsContracts = [];
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 post_only_mode_blocks_amount_after_downtime */ 35:
                    ...
                    break;
                case /* repeated injective.exchange.v2.EnforcedRestrictionsContract enforced_restrictions_contracts */ 36:
                    message.enforcedRestrictionsContracts.push(EnforcedRestrictionsContract.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated injective.exchange.v2.EnforcedRestrictionsContract enforced_restrictions_contracts = 36; */
        for (let i = 0; i < message.enforcedRestrictionsContracts.length; i++)
            EnforcedRestrictionsContract.internalBinaryWrite(message.enforcedRestrictionsContracts[i], writer.tag(36, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
