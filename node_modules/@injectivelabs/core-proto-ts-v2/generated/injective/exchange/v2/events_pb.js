...
class EventDerivativeMarketUpdate$Type extends MessageType {
  constructor() {
...
const EventDerivativeMarketUpdate = new EventDerivativeMarketUpdate$Type();
...
class EventPositionTransfer$Type extends MessageType {
  constructor() {
...
const EventPositionTransfer = new EventPositionTransfer$Type();
export {
