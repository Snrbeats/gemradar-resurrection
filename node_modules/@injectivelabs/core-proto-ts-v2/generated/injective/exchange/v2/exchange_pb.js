...
var ExecutionType = /* @__PURE__ */ ((ExecutionType2) => {
  ...
  ExecutionType2[ExecutionType2["Synthetic"] = 8] = "Synthetic";
  return ExecutionType2;
})(ExecutionType || {});
class EnforcedRestrictionsContract$Type extends MessageType {
  constructor() {
    super("injective.exchange.v2.EnforcedRestrictionsContract", [
      { no: 1, name: "contract_address", kind: "scalar", T: 9, options: { "cosmos_proto.scalar": "cosmos.AddressString" } },
      {
        no: 2,
        name: "pause_event_signature",
        kind: "scalar",
        T: 9
        /*ScalarType.STRING*/
      }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* string pause_event_signature */
        2:
...
const EnforcedRestrictionsContract = new EnforcedRestrictionsContract$Type();
class Params$Type extends MessageType {
  constructor() {
    super("injective.exchange.v2.Params", [
      ...
      { no: 36, name: "enforced_restrictions_contracts", kind: "message", repeat: 2, T: () => EnforcedRestrictionsContract, options: { "gogoproto.nullable": false } }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        35:
          ...
          break;
        case /* repeated injective.exchange.v2.EnforcedRestrictionsContract enforced_restrictions_contracts */
        36:
