...
var MarketStatus = /* @__PURE__ */ ((MarketStatus2) => {
  ...
  MarketStatus2[MarketStatus2["ForcePaused"] = 5] = "ForcePaused";
  return MarketStatus2;
})(MarketStatus || {});
var ForcePausedReason = /* @__PURE__ */ ((ForcePausedReason2) => {
  ForcePausedReason2[ForcePausedReason2["QuoteDenomPaused"] = 0] = "QuoteDenomPaused";
  return ForcePausedReason2;
})(ForcePausedReason || {});
class ForcePausedInfo$Type extends MessageType {
  constructor() {
    super("injective.exchange.v2.ForcePausedInfo", [
      ...
      { no: 2, name: "mark_price_at_pausing", kind: "scalar", T: 9, options: { "gogoproto.nullable": true, "gogoproto.customtype": "cosmossdk.io/math.LegacyDec" } }
    ]);
  }
  create(value) {
  ...
  internalBinaryRead(reader, length, options, target) {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* injective.exchange.v2.ForcePausedReason reason */
        1:
          message.reason = reader.int32();
          break;
        case /* string mark_price_at_pausing */
        2:
...
const ForcePausedInfo = new ForcePausedInfo$Type();
...
class SpotMarket$Type extends MessageType {
  constructor() {
    super("injective.exchange.v2.SpotMarket", [
      ...
      {
        no: 16,
        name: "has_disabled_minimal_protocol_fee",
        kind: "scalar",
        T: 8
        /*ScalarType.BOOL*/
      }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        15:
          ...
          break;
        case /* bool has_disabled_minimal_protocol_fee */
        16:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        22:
          message.hasDisabledMinimalProtocolFee = reader.bool();
          break;
        case /* injective.exchange.v2.ForcePausedInfo force_paused_info */
        23:
