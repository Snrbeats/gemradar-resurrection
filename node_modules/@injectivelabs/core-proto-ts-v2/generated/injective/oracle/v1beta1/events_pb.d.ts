...
/**
 * @generated from protobuf message injective.oracle.v1beta1.EventSetChainlinkDataStreamsPrices
 */
export interface EventSetChainlinkDataStreamsPrices {
    /**
     * @generated from protobuf field: repeated injective.oracle.v1beta1.ChainlinkDataStreamsPriceState prices = 1
     */
    prices: ChainlinkDataStreamsPriceState[];
}
...
// @generated message type with reflection information, may provide speed optimized methods
class EventSetChainlinkDataStreamsPrices$Type extends MessageType<EventSetChainlinkDataStreamsPrices> {
    constructor() {
        super("injective.oracle.v1beta1.EventSetChainlinkDataStreamsPrices", [
            { no: 1, name: "prices", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ChainlinkDataStreamsPriceState }
        ]);
    }
    create(value?: PartialMessage<EventSetChainlinkDataStreamsPrices>): EventSetChainlinkDataStreamsPrices {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.prices = [];
        if (value !== undefined)
            reflectionMergePartial<EventSetChainlinkDataStreamsPrices>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: EventSetChainlinkDataStreamsPrices): EventSetChainlinkDataStreamsPrices {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated injective.oracle.v1beta1.ChainlinkDataStreamsPriceState prices */ 1:
    ...
    internalBinaryWrite(message: EventSetChainlinkDataStreamsPrices, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated injective.oracle.v1beta1.ChainlinkDataStreamsPriceState prices = 1; */
        for (let i = 0; i < message.prices.length; i++)
...
/**
 * @generated MessageType for protobuf message injective.oracle.v1beta1.EventSetChainlinkDataStreamsPrices
 */
export const EventSetChainlinkDataStreamsPrices = new EventSetChainlinkDataStreamsPrices$Type();
