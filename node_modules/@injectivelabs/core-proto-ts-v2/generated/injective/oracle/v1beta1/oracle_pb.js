...
var OracleType = /* @__PURE__ */ ((OracleType2) => {
  ...
  OracleType2[OracleType2["ChainlinkDataStreams"] = 13] = "ChainlinkDataStreams";
  return OracleType2;
})(OracleType || {});
class Params$Type extends MessageType {
  constructor() {
    super("injective.oracle.v1beta1.Params", [
      ...
      {
        no: 2,
        name: "chainlink_verifier_proxy_contract",
        kind: "scalar",
        T: 9
        /*ScalarType.STRING*/
      },
      {
        no: 3,
        name: "accept_unverified_chainlink_data_streams_reports",
        kind: "scalar",
        T: 8
        /*ScalarType.BOOL*/
      },
      {
        no: 4,
        name: "chainlink_data_streams_verification_gas_limit",
        kind: "scalar",
        T: 4,
        L: 0
        /*LongType.BIGINT*/
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          ...
          break;
        case /* string chainlink_verifier_proxy_contract */
        2:
          message.chainlinkVerifierProxyContract = reader.string();
          break;
        case /* bool accept_unverified_chainlink_data_streams_reports */
        3:
          message.acceptUnverifiedChainlinkDataStreamsReports = reader.bool();
          break;
        case /* uint64 chainlink_data_streams_verification_gas_limit */
        4:
...
class ChainlinkDataStreamsPriceState$Type extends MessageType {
  constructor() {
    super("injective.oracle.v1beta1.ChainlinkDataStreamsPriceState", [
      ...
      { no: 2, name: "report_price", kind: "scalar", T: 9, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int" } },
      {
        no: 3,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        1:
          message.feedId = reader.string();
          break;
        case /* string report_price */
        2:
          message.reportPrice = reader.string();
          break;
        case /* uint64 valid_from_timestamp */
        3:
          message.validFromTimestamp = reader.uint64().toBigInt();
          break;
        case /* uint64 observations_timestamp */
        4:
...
const ChainlinkDataStreamsPriceState = new ChainlinkDataStreamsPriceState$Type();
...
class ChainlinkReport$Type extends MessageType {
  constructor() {
...
const ChainlinkReport = new ChainlinkReport$Type();
export {
  AssetPair,
  BandIBCParams,
  BandOracleRequest,
