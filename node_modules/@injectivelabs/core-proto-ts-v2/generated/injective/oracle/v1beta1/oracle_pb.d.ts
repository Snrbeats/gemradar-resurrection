...
/**
 * @generated from protobuf message injective.oracle.v1beta1.ChainlinkDataStreamsPriceState
 */
export interface ChainlinkDataStreamsPriceState {
    /**
     * @generated from protobuf field: string feed_id = 1
     */
    feedId: string;
    /**
     * @generated from protobuf field: string report_price = 2
     */
    reportPrice: string;
    /**
     * @generated from protobuf field: uint64 valid_from_timestamp = 3
     */
    validFromTimestamp: bigint;
    /**
     * @generated from protobuf field: uint64 observations_timestamp = 4
     */
...
/**
 * @generated from protobuf message injective.oracle.v1beta1.ChainlinkReport
 */
export interface ChainlinkReport {
    /**
     * @generated from protobuf field: bytes feed_id = 1
     */
    feedId: Uint8Array;
    /**
     * @generated from protobuf field: bytes full_report = 2
     */
...
class Params$Type extends MessageType<Params> {
    constructor() {
        super("injective.oracle.v1beta1.Params", [
            ...
            { no: 2, name: "chainlink_verifier_proxy_contract", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "accept_unverified_chainlink_data_streams_reports", kind: "scalar", T: 8 /*ScalarType.BOOL*/ },
            { no: 4, name: "chainlink_data_streams_verification_gas_limit", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ], { "gogoproto.equal": true, "amino.name": "oracle/Params" });
    }
    create(value?: PartialMessage<Params>): Params {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.pythContract = "";
        message.chainlinkVerifierProxyContract = "";
        message.acceptUnverifiedChainlinkDataStreamsReports = false;
        message.chainlinkDataStreamsVerificationGasLimit = 0n;
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string pyth_contract */ 1:
                    ...
                    break;
                case /* string chainlink_verifier_proxy_contract */ 2:
                    message.chainlinkVerifierProxyContract = reader.string();
                    break;
                case /* bool accept_unverified_chainlink_data_streams_reports */ 3:
                    message.acceptUnverifiedChainlinkDataStreamsReports = reader.bool();
                    break;
                case /* uint64 chainlink_data_streams_verification_gas_limit */ 4:
                    message.chainlinkDataStreamsVerificationGasLimit = reader.uint64().toBigInt();
                    break;
                default:
    ...
    internalBinaryWrite(message: Params, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.chainlinkVerifierProxyContract !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.chainlinkVerifierProxyContract);
        /* bool accept_unverified_chainlink_data_streams_reports = 3; */
        if (message.acceptUnverifiedChainlinkDataStreamsReports !== false)
            writer.tag(3, WireType.Varint).bool(message.acceptUnverifiedChainlinkDataStreamsReports);
        /* uint64 chainlink_data_streams_verification_gas_limit = 4; */
        if (message.chainlinkDataStreamsVerificationGasLimit !== 0n)
            writer.tag(4, WireType.Varint).uint64(message.chainlinkDataStreamsVerificationGasLimit);
...
// @generated message type with reflection information, may provide speed optimized methods
class ChainlinkDataStreamsPriceState$Type extends MessageType<ChainlinkDataStreamsPriceState> {
    constructor() {
        super("injective.oracle.v1beta1.ChainlinkDataStreamsPriceState", [
            { no: 1, name: "feed_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "report_price", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "gogoproto.nullable": false, "gogoproto.customtype": "cosmossdk.io/math.Int" } },
            { no: 3, name: "valid_from_timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "observations_timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 5, name: "price_state", kind: "message", T: () => PriceState, options: { "gogoproto.nullable": false } }
        ]);
    }
    create(value?: PartialMessage<ChainlinkDataStreamsPriceState>): ChainlinkDataStreamsPriceState {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.feedId = "";
        message.reportPrice = "";
        message.validFromTimestamp = 0n;
        message.observationsTimestamp = 0n;
        if (value !== undefined)
            reflectionMergePartial<ChainlinkDataStreamsPriceState>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChainlinkDataStreamsPriceState): ChainlinkDataStreamsPriceState {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string feed_id */ 1:
                    message.feedId = reader.string();
                    break;
                case /* string report_price */ 2:
                    message.reportPrice = reader.string();
                    break;
                case /* uint64 valid_from_timestamp */ 3:
                    message.validFromTimestamp = reader.uint64().toBigInt();
                    break;
                case /* uint64 observations_timestamp */ 4:
                    message.observationsTimestamp = reader.uint64().toBigInt();
                    break;
                case /* injective.oracle.v1beta1.PriceState price_state */ 5:
                    message.priceState = PriceState.internalBinaryRead(reader, reader.uint32(), options, message.priceState);
                    break;
    ...
    internalBinaryWrite(message: ChainlinkDataStreamsPriceState, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string feed_id = 1; */
        if (message.feedId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.feedId);
        /* string report_price = 2; */
        if (message.reportPrice !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.reportPrice);
        /* uint64 valid_from_timestamp = 3; */
        if (message.validFromTimestamp !== 0n)
            writer.tag(3, WireType.Varint).uint64(message.validFromTimestamp);
        /* uint64 observations_timestamp = 4; */
        if (message.observationsTimestamp !== 0n)
            writer.tag(4, WireType.Varint).uint64(message.observationsTimestamp);
        /* injective.oracle.v1beta1.PriceState price_state = 5; */
        if (message.priceState)
            PriceState.internalBinaryWrite(message.priceState, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message injective.oracle.v1beta1.ChainlinkDataStreamsPriceState
 */
export const ChainlinkDataStreamsPriceState = new ChainlinkDataStreamsPriceState$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
// @generated message type with reflection information, may provide speed optimized methods
class ChainlinkReport$Type extends MessageType<ChainlinkReport> {
    constructor() {
        super("injective.oracle.v1beta1.ChainlinkReport", [
            { no: 1, name: "feed_id", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 2, name: "full_report", kind: "scalar", T: 12 /*ScalarType.BYTES*/ },
            { no: 3, name: "valid_from_timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "observations_timestamp", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<ChainlinkReport>): ChainlinkReport {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.feedId = new Uint8Array(0);
        message.fullReport = new Uint8Array(0);
        message.validFromTimestamp = 0n;
        message.observationsTimestamp = 0n;
        if (value !== undefined)
            reflectionMergePartial<ChainlinkReport>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ChainlinkReport): ChainlinkReport {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* bytes feed_id */ 1:
                    message.feedId = reader.bytes();
                    break;
                case /* bytes full_report */ 2:
                    message.fullReport = reader.bytes();
                    break;
                case /* uint64 valid_from_timestamp */ 3:
                    message.validFromTimestamp = reader.uint64().toBigInt();
                    break;
    ...
    internalBinaryWrite(message: ChainlinkReport, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes feed_id = 1; */
        if (message.feedId.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.feedId);
        /* bytes full_report = 2; */
        if (message.fullReport.length)
            writer.tag(2, WireType.LengthDelimited).bytes(message.fullReport);
        /* uint64 valid_from_timestamp = 3; */
        if (message.validFromTimestamp !== 0n)
            writer.tag(3, WireType.Varint).uint64(message.validFromTimestamp);
        /* uint64 observations_timestamp = 4; */
...
/**
 * @generated MessageType for protobuf message injective.oracle.v1beta1.ChainlinkReport
 */
export const ChainlinkReport = new ChainlinkReport$Type();
