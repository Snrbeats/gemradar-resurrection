    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        20:
          ...
          break;
        case /* tendermint.abci.RequestInsertTx insert_tx */
        21:
          message.value = {
            oneofKind: "insertTx",
            insertTx: RequestInsertTx.internalBinaryRead(reader, reader.uint32(), options, message.value.insertTx)
          };
          break;
        case /* tendermint.abci.RequestReapTxs reap_txs */
        22:
          message.value = {
            oneofKind: "reapTxs",
            reapTxs: RequestReapTxs.internalBinaryRead(reader, reader.uint32(), options, message.value.reapTxs)
          };
          break;
        default:
...
class RequestInsertTx$Type extends MessageType {
  constructor() {
...
const RequestInsertTx = new RequestInsertTx$Type();
class RequestReapTxs$Type extends MessageType {
  constructor() {
...
const RequestReapTxs = new RequestReapTxs$Type();
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        21:
          ...
          break;
        case /* tendermint.abci.ResponseInsertTx insert_tx */
        22:
          message.value = {
            oneofKind: "insertTx",
            insertTx: ResponseInsertTx.internalBinaryRead(reader, reader.uint32(), options, message.value.insertTx)
          };
          break;
        case /* tendermint.abci.ResponseReapTxs reap_txs */
        23:
          message.value = {
            oneofKind: "reapTxs",
            reapTxs: ResponseReapTxs.internalBinaryRead(reader, reader.uint32(), options, message.value.reapTxs)
          };
          break;
        default:
          let u = options.readUnknownField;
...
class ResponseInsertTx$Type extends MessageType {
  constructor() {
...
const ResponseInsertTx = new ResponseInsertTx$Type();
class ResponseReapTxs$Type extends MessageType {
  constructor() {
...
const ResponseReapTxs = new ResponseReapTxs$Type();
