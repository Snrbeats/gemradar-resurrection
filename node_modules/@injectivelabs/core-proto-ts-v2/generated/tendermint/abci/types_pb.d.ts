...
export interface Request {
    ...
    value: {
        ...
        oneofKind: "insertTx";
        /**
         * @generated from protobuf field: tendermint.abci.RequestInsertTx insert_tx = 21
         */
        insertTx: RequestInsertTx;
    } | {
        oneofKind: "reapTxs";
        /**
         * @generated from protobuf field: tendermint.abci.RequestReapTxs reap_txs = 22
         */
        reapTxs: RequestReapTxs;
    } | {
        oneofKind: undefined;
    };
}
...
/**
 * @generated from protobuf message tendermint.abci.RequestInsertTx
 */
export interface RequestInsertTx {
    /**
     * @generated from protobuf field: bytes tx = 1
     */
    tx: Uint8Array;
...
/**
 * @generated from protobuf message tendermint.abci.RequestReapTxs
 */
export interface RequestReapTxs {
    /**
     * @generated from protobuf field: uint64 max_bytes = 1
     */
    maxBytes: bigint;
    /**
...
export interface Response {
    ...
    value: {
        ...
        oneofKind: "insertTx";
        /**
         * @generated from protobuf field: tendermint.abci.ResponseInsertTx insert_tx = 22
         */
        insertTx: ResponseInsertTx;
    } | {
        oneofKind: "reapTxs";
        /**
         * @generated from protobuf field: tendermint.abci.ResponseReapTxs reap_txs = 23
         */
        reapTxs: ResponseReapTxs;
    } | {
        oneofKind: undefined;
    };
}
...
/**
 * @generated from protobuf message tendermint.abci.ResponseInsertTx
 */
export interface ResponseInsertTx {
    /**
     * @generated from protobuf field: uint32 code = 1
     */
    code: number;
...
/**
 * @generated from protobuf message tendermint.abci.ResponseReapTxs
 */
export interface ResponseReapTxs {
    /**
     * @generated from protobuf field: repeated bytes txs = 1
     */
    txs: Uint8Array[];
...
class Request$Type extends MessageType<Request> {
    constructor() {
        super("tendermint.abci.Request", [
            ...
            { no: 21, name: "insert_tx", kind: "message", oneof: "value", T: () => RequestInsertTx },
            { no: 22, name: "reap_txs", kind: "message", oneof: "value", T: () => RequestReapTxs }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* tendermint.abci.RequestFinalizeBlock finalize_block */ 20:
                    ...
                    break;
                case /* tendermint.abci.RequestInsertTx insert_tx */ 21:
                    message.value = {
                        oneofKind: "insertTx",
                        insertTx: RequestInsertTx.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).insertTx)
                    };
                    break;
                case /* tendermint.abci.RequestReapTxs reap_txs */ 22:
                    message.value = {
                        oneofKind: "reapTxs",
                        reapTxs: RequestReapTxs.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).reapTxs)
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message: Request, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* tendermint.abci.RequestInsertTx insert_tx = 21; */
        if (message.value.oneofKind === "insertTx")
            RequestInsertTx.internalBinaryWrite(message.value.insertTx, writer.tag(21, WireType.LengthDelimited).fork(), options).join();
        /* tendermint.abci.RequestReapTxs reap_txs = 22; */
        if (message.value.oneofKind === "reapTxs")
            RequestReapTxs.internalBinaryWrite(message.value.reapTxs, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
...
// @generated message type with reflection information, may provide speed optimized methods
class RequestInsertTx$Type extends MessageType<RequestInsertTx> {
    constructor() {
        super("tendermint.abci.RequestInsertTx", [
            { no: 1, name: "tx", kind: "scalar", T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<RequestInsertTx>): RequestInsertTx {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.tx = new Uint8Array(0);
        if (value !== undefined)
            reflectionMergePartial<RequestInsertTx>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RequestInsertTx): RequestInsertTx {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: RequestInsertTx, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bytes tx = 1; */
        if (message.tx.length)
            writer.tag(1, WireType.LengthDelimited).bytes(message.tx);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message tendermint.abci.RequestInsertTx
 */
export const RequestInsertTx = new RequestInsertTx$Type();
// @generated message type with reflection information, may provide speed optimized methods
class RequestReapTxs$Type extends MessageType<RequestReapTxs> {
    constructor() {
        super("tendermint.abci.RequestReapTxs", [
            { no: 1, name: "max_bytes", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "max_gas", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<RequestReapTxs>): RequestReapTxs {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.maxBytes = 0n;
        message.maxGas = 0n;
        if (value !== undefined)
            reflectionMergePartial<RequestReapTxs>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: RequestReapTxs): RequestReapTxs {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* uint64 max_bytes */ 1:
                    message.maxBytes = reader.uint64().toBigInt();
                    break;
                case /* uint64 max_gas */ 2:
    ...
    internalBinaryWrite(message: RequestReapTxs, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint64 max_bytes = 1; */
        if (message.maxBytes !== 0n)
            writer.tag(1, WireType.Varint).uint64(message.maxBytes);
        /* uint64 max_gas = 2; */
        if (message.maxGas !== 0n)
            writer.tag(2, WireType.Varint).uint64(message.maxGas);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message tendermint.abci.RequestReapTxs
 */
export const RequestReapTxs = new RequestReapTxs$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
class Response$Type extends MessageType<Response> {
    constructor() {
        super("tendermint.abci.Response", [
            ...
            { no: 22, name: "insert_tx", kind: "message", oneof: "value", T: () => ResponseInsertTx },
            { no: 23, name: "reap_txs", kind: "message", oneof: "value", T: () => ResponseReapTxs }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* tendermint.abci.ResponseFinalizeBlock finalize_block */ 21:
                    ...
                    break;
                case /* tendermint.abci.ResponseInsertTx insert_tx */ 22:
                    message.value = {
                        oneofKind: "insertTx",
                        insertTx: ResponseInsertTx.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).insertTx)
                    };
                    break;
                case /* tendermint.abci.ResponseReapTxs reap_txs */ 23:
                    message.value = {
                        oneofKind: "reapTxs",
                        reapTxs: ResponseReapTxs.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).reapTxs)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Response, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* tendermint.abci.ResponseInsertTx insert_tx = 22; */
        if (message.value.oneofKind === "insertTx")
            ResponseInsertTx.internalBinaryWrite(message.value.insertTx, writer.tag(22, WireType.LengthDelimited).fork(), options).join();
        /* tendermint.abci.ResponseReapTxs reap_txs = 23; */
        if (message.value.oneofKind === "reapTxs")
            ResponseReapTxs.internalBinaryWrite(message.value.reapTxs, writer.tag(23, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class ResponseInsertTx$Type extends MessageType<ResponseInsertTx> {
    constructor() {
        super("tendermint.abci.ResponseInsertTx", [
            { no: 1, name: "code", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<ResponseInsertTx>): ResponseInsertTx {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.code = 0;
        if (value !== undefined)
            reflectionMergePartial<ResponseInsertTx>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ResponseInsertTx): ResponseInsertTx {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ResponseInsertTx, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 code = 1; */
        if (message.code !== 0)
            writer.tag(1, WireType.Varint).uint32(message.code);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message tendermint.abci.ResponseInsertTx
 */
export const ResponseInsertTx = new ResponseInsertTx$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ResponseReapTxs$Type extends MessageType<ResponseReapTxs> {
    constructor() {
        super("tendermint.abci.ResponseReapTxs", [
            { no: 1, name: "txs", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 12 /*ScalarType.BYTES*/ }
        ]);
    }
    create(value?: PartialMessage<ResponseReapTxs>): ResponseReapTxs {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.txs = [];
        if (value !== undefined)
            reflectionMergePartial<ResponseReapTxs>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ResponseReapTxs): ResponseReapTxs {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: ResponseReapTxs, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated bytes txs = 1; */
        for (let i = 0; i < message.txs.length; i++)
            writer.tag(1, WireType.LengthDelimited).bytes(message.txs[i]);
        let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message tendermint.abci.ResponseReapTxs
 */
export const ResponseReapTxs = new ResponseReapTxs$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const ABCI = new ServiceType("tendermint.abci.ABCI", [
    ...
    { name: "InsertTx", options: {}, I: RequestInsertTx, O: ResponseInsertTx },
    { name: "ReapTxs", options: {}, I: RequestReapTxs, O: ResponseReapTxs },
