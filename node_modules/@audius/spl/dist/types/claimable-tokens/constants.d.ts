export declare enum ClaimableTokensInstruction {
    Create = 0,
    Transfer = 1
}
/**
 ...
 */
export declare enum ClaimableTokensErrorCode {
    SignatureVerificationFailed = 0,
    Secp256InstructionLosing = 1,
    InstructionLoadError = 2,
    NonceVerificationError = 3
}
/**
