...
import type { ChangeCredentialsArgs, CreateKey, GetFn, LocalStorage, SetAuthFn, SetUserFn, LoginArgs } from "./types";
export declare class Hedgehog {
     ...
     */
    signUp({ username, password, ...optionalParams }: LoginArgs): Promise<Wallet>;
    /**
     ...
     */
    resetPassword({ username, password, ...optionalParams }: LoginArgs): Promise<void>;
    /**
     * Generate new set of auth credentials to allow login and remove the old credentials
     * Note: Doesn't log out on error
     */
    changeCredentials({ newUsername, newPassword, oldUsername, oldPassword, ...optionalParams }: ChangeCredentialsArgs): Promise<void>;
    /**
     ...
     * @returns ethereumjs-wallet wallet object
     */
    login({ username, password, ...optionalParams }: LoginArgs): Promise<Wallet>;
    /**
     ...
     */
    confirmCredentials({ username, password, ...optionalParams }: LoginArgs): Promise<boolean>;
    /**
