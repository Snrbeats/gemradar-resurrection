...
export declare class ServiceTypeManagerClient extends EthereumContract {
    ...
    getDiscoveryNodeVersion: () => Promise<string>;
    getContentNodeVersion: () => Promise<string>;
    getValidatorVersion: () => Promise<string>;
}
