...
import { PublicKey, VersionedTransaction, SendOptions, Transaction } from '@solana/web3.js';
import { z } from 'zod';
...
export declare const PublicKeySchema: z.ZodUnion<[z.ZodEffects<z.ZodString, PublicKey, string>, z.ZodType<PublicKey, z.ZodTypeDef, PublicKey>]>;
export declare const TokenNameSchema: z.ZodEnum<["wAUDIO", "USDC"]>;
export type TokenName = z.input<typeof TokenNameSchema>;
export declare const MintSchema: z.ZodUnion<[z.ZodEnum<["wAUDIO", "USDC"]>, z.ZodUnion<[z.ZodEffects<z.ZodString, PublicKey, string>, z.ZodType<PublicKey, z.ZodTypeDef, PublicKey>]>]>;
export type Mint = z.input<typeof MintSchema>;
export declare const RelaySchema: z.ZodObject<{
    transaction: z.ZodType<VersionedTransaction | Transaction, z.ZodTypeDef, VersionedTransaction | Transaction>;
    /**
     ...
     */
    confirmationOptions: z.ZodOptional<z.ZodObject<{
        /**
         ...
         */
        strategy: z.ZodOptional<z.ZodUnion<[z.ZodObject<{
            ...
            minContextSlot: z.ZodNumber;
            nonceAccountPubkey: z.ZodUnion<[z.ZodEffects<z.ZodString, PublicKey, string>, z.ZodType<PublicKey, z.ZodTypeDef, PublicKey>]>;
            nonceValue: z.ZodString;
        }, "strip", z.ZodTypeAny, {
            ...
            minContextSlot: number;
            nonceAccountPubkey: (string | PublicKey) & (string | PublicKey | undefined);
            nonceValue: string;
        }>]>>;
        /**
         ...
         */
        commitment: z.ZodOptional<z.ZodEnum<["processed", "confirmed", "finalized", "recent", "single", "singleGossip", "root", "max"]>>;
    }, "strip", z.ZodTypeAny, {
        strategy?: {
            blockhash: string;
            lastValidBlockHeight: number;
        ...
        commitment?: "finalized" | "processed" | "confirmed" | "recent" | "single" | "singleGossip" | "root" | "max" | undefined;
    }, {
        strategy?: {
            blockhash: string;
            lastValidBlockHeight: number;
     ...
     */
    sendOptions: z.ZodOptional<z.ZodType<SendOptions, z.ZodTypeDef, SendOptions>>;
}, "strict", z.ZodTypeAny, {
    transaction: (VersionedTransaction | Transaction) & (VersionedTransaction | Transaction | undefined);
    confirmationOptions?: {
        strategy?: {
            blockhash: string;
            lastValidBlockHeight: number;
...
export type RelayRequestBody = Prettify<Omit<RelayRequest, 'transaction'> & {
    /**
     * Base64 encoded serialized VersionedTransaction object.
     */
    transaction: string;
}>;
export declare const LaunchCoinSchema: z.ZodObject<{
    name: z.ZodString;
    symbol: z.ZodString;
    description: z.ZodString;
    walletPublicKey: z.ZodUnion<[z.ZodEffects<z.ZodString, PublicKey, string>, z.ZodType<PublicKey, z.ZodTypeDef, PublicKey>]>;
    initialBuyAmountAudio: z.ZodOptional<z.ZodString>;
    ...
    name: string;
    description: string;
    walletPublicKey: (string | PublicKey) & (string | PublicKey | undefined);
    image: Blob;
    initialBuyAmountAudio?: string | undefined;
}>;
...
export type ClaimVestedCoinsResponse = {
    claimVestedCoinsTxs: Array<string>;
