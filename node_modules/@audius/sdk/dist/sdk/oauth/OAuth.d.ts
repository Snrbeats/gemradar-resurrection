...
import { OAuthScope, IsWriteAccessGrantedRequest, WriteOnceParams, OAuthEnv } from './types';
export type LoginSuccessCallback = (profile: DecodedUserToken, encodedJwt: string) => void;
...
export declare class OAuth {
    ...
    login({ scope, params, redirectUri, display, responseMode }: {
        scope?: OAuthScope;
